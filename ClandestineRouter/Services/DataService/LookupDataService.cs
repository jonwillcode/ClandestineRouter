...
public class LookupDataService<TEntity> : IDataService<TEntity> where TEntity : class, ILookupEntity
{
    private readonly ApplicationDbContext _context;
    private readonly ILogger<LookupDataService<TEntity>> _logger;
    ...
    public LookupDataService(
        ...
        ILogger<LookupDataService<TEntity>> logger,
        IMemoryCache cache,
